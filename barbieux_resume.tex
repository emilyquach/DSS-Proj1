...
\usepackage[left=0.5in,right=0.5in,top=0.5in,bottom=0in]{geometry}
...
\title{Eavan Barbieux}
\author{ebarbieux@berkeley.edu \textbullet PO Box 982, Berkeley, CA \textbullet (805) 708-3848}
\date{}
\maketitle
...
\subsection*{{Tropical Biology and Conservation-Monteverde, Costa Rica} \hfill \textit {\small October 2017-December 2017}}

\begin{itemize}
    \item {Participated in study abroad program with focus on field biological research, conservation approaches, and agroecology.}
    \item{{Initiated and conducted independent research examining potential specialization in spider-inflorescence interactions; presented at final, public symposium}}
\end{itemize} 
